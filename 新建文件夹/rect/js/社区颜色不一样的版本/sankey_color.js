...
(function() {
  ...
  Sankey = (function() {
    function Sankey() {
	  ...
	  this.color = d3.scale.category20().domain(d3.range([0, 50]));
    ...
    Sankey.prototype.stack = function(x, box_names, y_box) {
		console.log("x: "+x+"  box_names: "+box_names+"  y_box: "+y_box)
  ...
  TransformationBox = (function() {
    ...
    TransformationBox.prototype.draw = function(r) {
	  ...
	  var cur_color = this.sankey.color(this.sankey.index);
	  this.sankey.index++;
	  
      this.box = r.rect(this.x, this.y, box_width, this.size())
	  .attr('fill',cur_color)
      .attr("stroke", "#C6E2FF");
